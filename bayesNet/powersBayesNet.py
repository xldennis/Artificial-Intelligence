...
class PowersBayesNet(object):
    ...
    def instantiateObservableVars(self,ghostPower):
        if(ghostPower == 'laser'):
            return self.LaserPowerObservationDict()
        if(ghostPower == 'blast'):
            return self.BlastPowerObservationDict()
        if(ghostPower == 'speed'):
            return self.SpeedPowerObservationDict()
        return self.NullPowerObservationDict()
    ...
    def LaserPowerObservationDict(self):
        evidenceDict = {}
    ...
    def BlastPowerObservationDict(self):
        evidenceDict = {}
    ...
    def SpeedPowerObservationDict(self):
        evidenceDict = {}
        evidenceDict['Time'] = 'day'
    ...
    def NullPowerObservationDict(self):
        evidenceDict = {}
        evidenceDict['Time'] = 'day'
        evidenceDict['Temp'] = 'cold'
        evidenceDict['Belt'] = '0'
...
if __name__ == "__main__":
    ...
    l = pbNet.inferGhostPowers(pbNet.LaserPowerObservationDict())
    e = pbNet.inferGhostPowers(pbNet.BlastPowerObservationDict())
    s = pbNet.inferGhostPowers(pbNet.SpeedPowerObservationDict())
    n = pbNet.inferGhostPowers(pbNet.NullPowerObservationDict())
    print l
    print e
    print s
    print n
